...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/components/datetimepicker/bootstrap-datetimepicker.css')}}">
...
<script type="text/javascript" language="javascript" src="{{asset('js/components/datetimepicker/moment-with-locales.js')}}"></script>
<script type="text/javascript" language="javascript" src="{{asset('js/components/datetimepicker/bootstrap-datetimepicker.js')}}"></script>
<script>
