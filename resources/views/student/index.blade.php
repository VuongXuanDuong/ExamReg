        ...
        <div>
            <div class="pull-right table-title-top-action">
                ...
                <a href="javascript:void(0);"
                   class="btn btn-primary pmd-btn-raised add-btn pmd-ripple-effect pull-left">Search</a>
            </div>
            <!-- Title -->
            ...
            <div class="pull-right pmd-card-body">
                <div class="pmd-textfield pull-left">
                    <button onclick="choose()" type="button" class="btn pmd-btn-raised pmd-ripple-effect btn-success">
                        Nhập excel
                        <form method="POST" action="{{route('importStudents')}}"
                    ...
                    <button type="button" class="btn pmd-btn-raised pmd-ripple-effect btn-success" data-toggle="modal"
                            data-target="#insertModal">Thêm
                    </button>
                </div>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td class="pmd-table-row-action">
                            <div account_id={{$account['id']}} account_info="{{$account}}">
                                <button type="button"
                                        class="btn-sm btn pmd-btn-fab pmd-btn-raised pmd-ripple-effect btn-warning"
                                        data-toggle="modal" data-target="#editModal" onclick="setValueEditForm(this)"><i
                                            class="material-icons md-dark pmd-xs">edit</i></button>

                                <button type="button"
                                        class="btn-sm btn pmd-btn-fab pmd-btn-raised pmd-ripple-effect btn-info"
                                        onclick="showStudentInfo(this);"><i
                                            class="material-icons md-dark pmd-xs">visibility</i></button>
                                {{-- Delete form --}}
                                <form class="" action="{{url('admin/sinh-vien/'.$account['id'])}}" method="post">
                                    {{method_field("delete")}}
                                    @csrf
                                    <button type="submit" class="
                      btn-sm btn pmd-btn-fab pmd-btn-raised pmd-ripple-effect btn-danger "
                                            onclick="return confirm('Bạn có chắc chắn muốn xóa mục này ?')"><i
                                                class="material-icons md-dark pmd-xs">delete</i></button>
                                </form>
                                {{-- End --}}
                            </div>
                        </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">Sửa tài khoản sinh viên</h4>
                ...
                <div class="modal-body">
                    <form id="formEdit" class="form-group" action="{{url('admin/giang-vien')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="re_password" id="passwordedit"
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="vnu_mail"
                                   required value="">
                        </div>
                        <div class="form-group">
                            <label for="#username">Lớp</label>
                            <input class="form-control" name="school_year" value="">
                        </div>
                        <!-- Modal footer -->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formInsert" class="form-group" action="{{url('admin/sinh-vien')}}" method="post">
                            ...
                            <div class="form-group">
                                <label>Tên đăng nhập</label>
                                <input type="text" class="form-control" id="student_account" name="username"
                                       placeholder="Nhập tài khoản" required value="">
                                <p style="color:red;display:none;" id="username-error"><i
                                            class="fas fa-exclamation-triangle"></i> Tên đăng nhập đã tồn tại</p>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="re_password"
                                       placeholder="Nhập lại mật khẩu" required value="">
                            </div>
                            <div class="form-group">
                                <label for="">Họ và tên</label>
                            ...
                            <div class="form-group">
                                <label for="#username">Email</label>
                                <input type="email" class="form-control" name="vnu_mail" placeholder="Nhập VNU email"
                                       required value="">
                            </div>
                            <div class="form-group">
                                <label for="#username">Lớp</label>
                                <input type="text" class="form-control" name="school_year"
                                       placeholder="Nhập lớp VD:QH-2015-I/CQ-CLC" required value="">
                            </div>
                            <!-- Modal footer -->
                            <div class="modal-footer">
